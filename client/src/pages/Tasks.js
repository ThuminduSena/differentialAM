      ...
      <main className="main-content">
        <div className="table-header">
          ...
          <div className="controls">
            ...
            <button className="control-btn">
              <img
                src="https://img.icons8.com/?size=100&id=ErgBpxkvZhKX&format=png&color=000000"
                alt="Filter Button"
              />{" "}
              Filter
            </button>
            <button className="control-btn">
              <img
                src="https://img.icons8.com/?size=100&id=9d3LRh30oaAP&format=png&color=000000"
                alt="Sort Button"
              />{" "}
              Sort
            </button>
            ...
            <button className="control-btn">
              <img
                src="https://img.icons8.com/?size=100&id=nW3o1ItakKJm&format=png&color=000000"
                alt="group Button"
              />{" "}
              Group by
            </button>
